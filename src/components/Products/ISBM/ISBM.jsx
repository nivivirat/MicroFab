...
export default function ISBM() {
  ...
  useEffect(() => {
    ...
    const advantagesRef = ref(db, 'ManufacturingPage/ISBM/advantages');
    ...
    const applicationsRef = ref(db, 'ManufacturingPage/ISBM/applications');
      ...
      <div className="w-full justify-center flex h-[500px] md:my-16">
        ...
        <div className="px-[10%] text-white relative flex flex-col gap-10 justify-center place-items-center bg-primary w-[80%] h-[80%] rounded-[15px] my-[2%]">
          ...
          <p className="font-normal md:text-[18px] xl:text-[18px] text-[16px] text-center">
            Microtools ISBM technology represents a cutting-edge solution for the efficient production of hollow plastic containers. By integrating the capabilities of injection molding and blow molding, this advanced process enables the creation of intricate designs with enhanced precision.
          </p>
      ...
      <div className="w-full bg-primary md:p-12 p-5 flex flex-col md:gap-8 gap-10">
        ...
        <div>
          <p className="md:text-4xl text-2xl font-semibold text-white tracking-wider">
            Advantages of the ISBM/PFFS Process
          </p>
        </div>
      ...
      <div className="md:px-14 mt-[5%] px-4 gap-10 flex flex-col">
        <div>
          <p className="font-semibold text-3xl">
            Applications of the ISBM/PFFS Technology
          </p>
        </div>
