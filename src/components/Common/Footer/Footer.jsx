          ...
          <div className="md:flex md:flex-row gap-6">
            <div className="md:w-[30%]">
              ...
              <div className="flex flex-row gap-4 md:mt-6 mt-6">
                Dedicated to excellence in executing innovative projects for the IV industry, delivering precision and reliability every step of the way. Join us in revolutionizing IV solutions with our expertise and commitment to quality.
              </div>
            </div>
            {/* vertical line */}
            {/* for mobile */}
