...
export default function Service() {
  ...
  useEffect(() => {
    ...
    if (hash) {
      ...
      if (element) {
        element.scrollIntoView({ behavior: "smooth", block: "start" }); // Adjust scroll behavior
      }
    }
  }, []);
  ...
  return (
    <>
      <br /><br /><br /><br />
      <div id="service" className="serv1">
        <div>
          <br /><br />
      ...
      <div id="project" className="md:pl-6 flex flex-wrap gap-7 md:gap-5 md:gap-y-4 md:p-0 p-8 md:place-items-start place-items-center md:justify-start justify-center animate__animated animate__fadeInRight animate__delay-2s">
          ...
          <div className="flex flex-col rounded-lg text-black md:max-w-5xl md:flex-row animate__animated animate__fadeInLeft animate__delay-3s">
            ...
            <div className="flex flex-col justify-start order-1 md:order-1">
              ...
              <h6 className="text-2xs xz hj text-[#67675F] leading-7" color="clack">
                When the entire gamut of production operational activities becomes cumbersome, you can approach us at that instance. With MicroFab, you can work closely with professionals that possess specialized skills and expertise. With advanced technologies, you can further expect higher quality products and an improvement in the production process.
              </h6>
            </div>
          </div>
          <br />
